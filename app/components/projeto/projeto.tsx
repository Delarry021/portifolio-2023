...
export default function Projeto(props: ProjetoProps) {
    return(
        <div className='flex border-b pb-52 sm:pb-24 border-b-zinc-300 dark:border-b-zinc-800 justify-around sm:px-16 w-full'>
            <div>
            <Image
            className='z-10'
            src={'/frame.svg'}
            ...
            <div className='flex flex-col justify-around lg:pl-12 lg:pr-72  sm:px-8 rounded-lg'>
